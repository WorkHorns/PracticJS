...
function timer(id, deadLine) {
  ...
  function getZero(num) {
    if (num >= 0 && num < 10) return `0${num}`;else {
      return num;
    }
  }
...
/* harmony import */ var _modules_modalWindow__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/modalWindow */ "./js/modules/modalWindow.js");
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/slider */ "./js/modules/slider.js");
(__webpack_require__(/*! es6-promise */ "./node_modules/es6-promise/dist/es6-promise.js").polyfill)(); //подключение поливил
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerID = setTimeout(() => (0,_modules_modalWindow__WEBPACK_IMPORTED_MODULE_6__.openModal)('.modal', modalTimerID), 30000);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer', '2023-05-15');
  ...
  (0,_modules_modalWindow__WEBPACK_IMPORTED_MODULE_6__["default"])('[data-modal]', '.modal', modalTimerID);
